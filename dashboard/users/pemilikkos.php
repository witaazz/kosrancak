...
if (isset($_POST['verified'])) {
    ...
    if ($verified_user) {
        echo '<script>alert("Pengguna telah diverifikasi!");window.location="?page=users/pemilikkos";</script>';
    } else {
        echo '<script>alert("Terjadi kesalahan!");window.location="?page=users/pemilikkos";</script>';
    }
} else if (isset($_POST['denied'])) {
    $id_user = $_POST['id_user'];
    $denied_user = mysqli_query($koneksi, "UPDATE users SET verif='Ditolak' WHERE id_user='$id_user'");
    if ($denied_user) {
        echo '<script>alert("Pengguna anda tolak!");window.location="?page=users/pemilikkos";</script>';
    } else {
        echo '<script>alert("Terjadi kesalahan!");window.location="?page=users/pemilikkos";</script>';
    }
}
